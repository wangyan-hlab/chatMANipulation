...
WELCOME_TEXT = "  您好!我是FR码垛小助手,我有两个主要功能: 1.帮助设置码垛参数 2.帮助生成码垛程序\n\n  在开始工作之前,我有几点需要和您说明:\n\n1.在进行参数设置时,与点位有关的参数需要您使用机器人进行示教,示教得到的点位数据需要您通过webapp界面复制粘贴到输入框中\n\n2.在示教托盘原点和吸盘位置时,请将一个工件准确摆放在右图示意的位置上,此时托盘原点是工件的几何中心\n\n3.通常情况下吸盘位置与工件几何中心重合,因此托盘原点和吸盘位置的示教可以使用同一个机器人姿态,但如果您的吸盘位置和工件几何中心不重合,请将托盘原点和吸盘位置分开示教\n\n  说明完毕,请对我说'你好'来开始吧!\n"
