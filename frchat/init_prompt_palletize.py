...
'托盘配置': {'前边长度': 0.0, '侧边长度': 0.0, '托盘高度': 0.0, '工位过渡点': [0, 0, 0, 0, 0, 0]}, 
'模式配置': {'工件间隔': 0.0, '每层行数': 1, '每层列数': 1, '码垛层数': 1}, 
'机器人移动配置': {'作业原点': [0, 0, 0, 0, 0, 0], '托盘原点':  [0, 0, 0, 0, 0, 0], '路径点':  [0, 0, 0, 0, 0, 0], '起始方位': [0, 0], '移动方向':'X', '运动方式': 'line', '运动路径': 'headtail', '堆叠方式': 'load'}}
